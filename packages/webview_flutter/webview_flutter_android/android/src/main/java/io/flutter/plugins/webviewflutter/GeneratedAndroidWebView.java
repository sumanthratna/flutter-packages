...
public class GeneratedAndroidWebView {
  ...
  public interface CookieManagerHostApi {
    ...
    @NonNull 
    String getCookies(@NonNull Long identifier, @NonNull String url);
    ...
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable CookieManagerHostApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.webview_flutter_android.CookieManagerHostApi.getCookies", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ...
                String urlArg = (String) args.get(1);
                try {
                  String output = api.getCookies((identifierArg == null) ? null : identifierArg.longValue(), urlArg);
